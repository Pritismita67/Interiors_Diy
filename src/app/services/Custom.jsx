    ...
    <div className="custom-container">
      <div className="custom-content">
        <div className="custom-image">
          ...
          <img 
            src="https://assets-news.housing.com/news/wp-content/uploads/2023/02/24224744/4-8.png" 
        ...
        <div className="custom-text">
          ...
          <h2 className="custom-title">Custom Design Consult</h2>
          
          <p className="custom-subtitle">Personalized to your lifestyle</p>
          ...
          <div className="custom-pricing">
            <h3 className="pricing-title">Starting from ₹4,999</h3>
            <p className="pricing-subtitle">Per room, includes revisions</p>
            
            <Link href="/custom-design" className="custom-button">
              Start Custom Design
            </Link>
          </div>
        </div>
