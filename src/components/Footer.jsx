    ...
    <footer className="footer-container">
      <div className="footer-content">
        ...
        <div className="footer-column footer-brand">
          ...
          <p className="footer-tagline">
            Affordable DIY Interior Design, <br></br>Completely Online
          </p>
          
          {/* Social Media Links */}
          <div className="footer-social">
            <a 
              href="https://www.instagram.com/do_interiors_yourself" 
              target="_blank" 
            ...
            <a 
              href="https://www.facebook.com/profile.php?id=61574644692974" 
              target="_blank" 
              rel="noopener noreferrer"
              className="social-icon"
              aria-label="Facebook"
            ...
            <a 
              href="https://in.pinterest.com/DoInteriorYourself/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="social-icon"
            ...
            <a 
              href="https://www.linkedin.com/company/106084147" 
              target="_blank" 
              rel="noopener noreferrer"
              className="social-icon"
              aria-label="LinkedIn"
            ...
            <a 
              href="https://www.youtube.com/@DoInteriorsYourself" 
              target="_blank" 
              rel="noopener noreferrer"
              className="social-icon"
              aria-label="YouTube"
      ...
      <div className="footer-bottom">
        <p className="footer-copyright">
          © 2026 Do Interiors Yourself. All rights reserved.
        </p>
